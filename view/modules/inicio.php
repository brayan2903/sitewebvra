    ...
    <style>
        ...
        .category-box {
            background-color: rgba(0, 0, 0, 0.4); /* Negro 40% de opacidad */
            padding: 10px;
            border-radius: 10px;
            display: flex;
        ...
        <div class="col-lg-12 access__direct animated zoomIn mb-5">
            ...
            <div class="container">
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 col-sm-6 text-center mb-3">
                        <a href="https://.unap.edu.pe/" class="d-block">
...
.btn-sm {
    font-size: 0.9rem; /* Tamaño pequeño del botón */
        ...
        #particles-js {
            ...
            background-image: url('./public/img/unap.jpg'); /* Reemplaza esto con la ruta correcta */
