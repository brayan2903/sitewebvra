            ...
            <div class="header__inner">
                ...
                <div class="header__brand">
                    <div class="brand-wrap">
                        ...
                        <!-- Brand title -->
                        <div class="brand-title">Admin VRA</div>
                    ...
                    <div class="mainnav__categoriy py-3">
                        ...
                        <ul class="mainnav__menu nav flex-column">
                            ...
                            <?php if ($_SESSION['S_ROL'] == 'Administrador') { ?>
                                ...
                                <!-- Estadistiscas submenu list -->
                                <li class="nav-item">
                                    <a onclick="cargar_contenido('content','modules/estadisticas/estadisticas.php')" class="nav-link mininav-toggle"><i class="bi bi-people fs-5 me-2"></i>

                                        <span class="nav-label mininav-content ms-1">Estadisticas</span>
                                    </a>
                                </li>
                                
                                <!--Estadisticas submenu list -->
...
<div class="modal fade" id="modal_credenciales" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
        window.CKEDITOR_DISABLE_NOTIFICATIONS = true; // Oculta la alerta roja
        CKEDITOR.config.disableNativeSpellChecker = true; // Desactiva el corrector ortográfico nativo (esto es solo un ejemplo)
    </script>
