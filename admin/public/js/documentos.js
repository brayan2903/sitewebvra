            ...
            },
            {
                "data": "doc_estado", render: function (data, type, row) {
                    if (data == 'ABIERTO') {
                        ...
                        return '<span class="badge bg-danger">NO VIGENTE</span>';
                    }
                }
            },
...
$('#tabla_documentos').on('click', '.editar', function () {
    ...
    document.getElementById('txt_id_doc').value = data.doc_id;
    document.getElementById('txt_titulo_edit').value = data.doc_titulo;
    document.getElementById('txt_numdoc_edit').value = data.num_doc;
    document.getElementById('select_estatus').value = data.doc_estado || 'VIGENTE';

    // Mostrar los nombres de los archivos en los campos de entrada
    if (data.doc_archivo1) {
        $("#txt_doc_archivo1_edit").val(''); // Limpia el campo de archivo
        $("#txt_doc_archivo1_edit").after('<input type="text" class="form-control" value="' + data.doc_archivo1 + '" readonly />'); // Mostrar nombre del archivo en un campo de texto
    }
    if (data.doc_archivo2) {
        $("#txt_doc_archivo2_edit").val('');
        $("#txt_doc_archivo2_edit").after('<input type="text" class="form-control" value="' + data.doc_archivo2 + '" readonly />');
    }
    if (data.doc_archivo3) {
        $("#txt_doc_archivo3_edit").val('');
        $("#txt_doc_archivo3_edit").after('<input type="text" class="form-control" value="' + data.doc_archivo3 + '" readonly />');
    }
    if (data.doc_archivo4) {
        $("#txt_doc_archivo4_edit").val('');
        $("#txt_doc_archivo4_edit").after('<input type="text" class="form-control" value="' + data.doc_archivo4 + '" readonly />');
    }
    if (data.doc_archivo5) {
        $("#txt_doc_archivo5_edit").val('');
        $("#txt_doc_archivo5_edit").after('<input type="text" class="form-control" value="' + data.doc_archivo5 + '" readonly />');
    }
});
