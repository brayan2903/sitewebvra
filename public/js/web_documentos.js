        ...
        "columns": [
            ...
            
            {
                "data": "doc_estado", "className": "text-center", render: function (data, type, row) {
                    return data === 'ABIERTO' 
                        ? '<span class="badge" style="background-color: blue; color: white; padding: 5px; border-radius: 10px;">VIGENTE</span>' 
                        : '<span class="badge" style="background-color: gray; color: white; padding: 5px; border-radius: 10px;">NO VIGENTE</span>';
                }
            }
