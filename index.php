...
echo "<h1>MODO DE PRUEBA DIRECTA</h1>";
echo "<p>Intentando incluir el archivo: /var/www/vra/view/modules/documentos/documentos.php</p>";

// Forzamos la inclusión del archivo de documentos, sin condiciones.
include 'view/modules/documentos/documentos.php';
